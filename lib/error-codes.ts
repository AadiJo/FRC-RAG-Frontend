...
export function getErrorMessage(code: ErrorCode): string {
  switch (code) {
    ...
    case ERROR_CODES.DAILY_LIMIT_REACHED:
      return "You've reached your daily limit. Add your own API key (free!) to unlock unlimited messages and all models.";
    case ERROR_CODES.MONTHLY_LIMIT_REACHED:
      return "You've reached your monthly limit. Add your own API key (free!) to unlock unlimited messages.";
    case ERROR_CODES.PREMIUM_LIMIT_REACHED:
      return "You've used all of your premium credits. Add your own API key to continue using premium models.";

...
export default function LoginPage() {
  ...
  return (
    <div className="flex h-dvh flex-col bg-gradient-to-b from-primary/5 to-background">
      <HeaderGoBack href="/chat" showControls={false} />
        ...
        <div className="w-full max-w-md space-y-8">
          <div className="text-center">
            <h1 className="mb-5 font-bold text-foreground text-xl">
              Welcome to{" "}
              <span className="-mt-1 ml-1.5 inline-block text-3xl text-primary">
                {APP_NAME}
              </span>
            </h1>

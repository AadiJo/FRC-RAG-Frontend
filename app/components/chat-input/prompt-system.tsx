  ...
  return (
    <>
      ...
      <motion.div
        ...
        className="relative right-0 bottom-0 left-0 mx-auto mb-4 flex h-8 w-auto items-center justify-center rounded-lg p-1 md:fixed md:bottom-0 md:left-1/2 md:-translate-x-1/2"
        initial={{
          transform: isSidebarOpen ? "translateX(128px)" : "translateX(0px)",
        }}

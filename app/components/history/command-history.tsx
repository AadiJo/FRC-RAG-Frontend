                ...
                {messageResults.map((msg) => (
                  <CommandItem
                    ...
                    onSelect={() => {
                      ...
                      router.replace(`/chat/${msg.chatId}?m=${msg._id}`, {
                        scroll: false,
                      });
                      setIsOpen(false);
                    }}
              ...
              (groupKey) =>
                hasChatsInGroup(groupedChats, groupKey) && (
                  <div className="px-2 pb-2" key={groupKey}>
                    <div className="mb-1 flex h-8 shrink-0 items-center rounded-md px-1.5 font-semibold text-muted-foreground text-sm uppercase tracking-wide">
                      {groupKey}
                    </div>

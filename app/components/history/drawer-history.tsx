...
export function DrawerHistory({
  ...
  return (
    <Drawer onOpenChange={handleOpenChange} open={isOpen}>
      ...
      <DrawerContent className="dark-blue">
        <DrawerHeader>
                ...
                (groupKey) =>
                  hasChatsInGroup(groupedChats, groupKey) && (
                    <div className="space-y-2" key={groupKey}>
                      <h3 className="px-2 pb-1 font-medium text-muted-foreground text-xs uppercase tracking-wider">
                        {groupKey}
                      </h3>

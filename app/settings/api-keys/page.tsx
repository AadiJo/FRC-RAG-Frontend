    ...
    <div className="w-full">
      <div className="space-y-6">
        ...
        <div className="space-y-2">
          ...
          <p className="text-muted-foreground text-xs">
            Tavily enables the web search tool. Creating and using provider API
            keys is free — usage is subject to each provider's rate limits.
          </p>
        </div>

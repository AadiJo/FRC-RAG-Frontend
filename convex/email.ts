...
// TODO: Resend email component disabled - stub implementation
// Email sending is not available in this simplified version
const resend = {
  sendEmail(
    _ctx: unknown,
    _args: {
    ...
    console.log("[EMAIL] Email sending disabled in simplified version");
    ...
    <div class="email-container">
        ...
        <div class="content">
            ...
            <div class="output">
                ...
                <div class="button-container">
                    <a href="${process.env.NEXT_PUBLIC_APP_URL || "https://frcrag.johari-dev.com"}/chat/${chatId}" class="cli-button">
                        open dashboard
                    </a>
                </div>
        ...
        <div class="footer">
            ...
            <div class="footer-line">
                ...
                <a href="${process.env.NEXT_PUBLIC_APP_URL || "https://frcrag.johari-dev.com"}/settings" class="footer-link">account_settings</a>
            </div>
        </div>
    </div>
</body>
...
//                 <a href="${process.env.NEXT_PUBLIC_APP_URL || 'https://frcrag.johari-dev.com'}/chat/${chatId}" class="cta-button">
//                     View Full Results
//                 </a>
//             </div>
//         </div>
...
//             <p class="footer-text">You can manage your notification preferences in your <a href="${process.env.NEXT_PUBLIC_APP_URL || 'https://frcrag.johari-dev.com'}/settings" class="footer-link">account settings</a>.</p>
//         </div>
//     </div>
// </body>
// </html>`;
...
View full results: ${process.env.NEXT_PUBLIC_APP_URL || "https://frcrag.johari-dev.com"}/chat/${chatId}

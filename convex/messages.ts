 ...
 * TODO: R2 storage disabled - stub implementation
 */
async function cleanupSingleAttachment(
  ...
  // R2 storage disabled - just delete the DB record if found
  // When VPS storage is implemented, add cleanup logic here
}
...
async function cleanupOrphanedAttachments(
  ...
  // R2 storage disabled - just delete the DB records
...
// Internal query for debugging message persistence without auth
export const debugGetMessagesForChatInternal = internalQuery({
  args: { chatId: v.id("chats") },

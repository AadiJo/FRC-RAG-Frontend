    ...
    <div className="relative min-h-screen overflow-hidden bg-[#080808] text-white text-sm sm:text-base">
      ...
      <div className="relative z-10 mx-auto flex min-h-screen max-w-[1700px] flex-col px-4 pb-16 pt-10 sm:px-8 lg:px-32">
        <nav className="mb-10 flex items-center justify-between rounded-full border border-white/5 bg-white/5 px-4 py-3 backdrop-blur-md">
          ...
          <Button variant="secondary" className="border border-white/10 bg-white/5 text-white hover:bg-white/10 rounded-xl" asChild>
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              <h1 className="text-4xl font-semibold leading-tight tracking-tight sm:text-5xl lg:text-7xl">
                <span className="whitespace-pre-wrap block min-h-[8.5rem] sm:min-h-[11.5rem] lg:min-h-[14rem]">
                  {typed || "\u00A0"}
            ...
            <div className="flex flex-wrap items-center gap-3 text-xs sm:text-sm text-white/80 justify-center sm:justify-start">
            ...
            {(!user) && (
              <div className="flex flex-wrap items-center justify-center sm:justify-start gap-3 mt-8">
                <Button size="default" className="h-10 px-4 sm:h-12 sm:px-6 rounded-lg sm:rounded-xl bg-gradient-to-r from-blue-500 via-indigo-500 to-rose-500 text-sm sm:text-base shadow-lg shadow-blue-500/30" asChild>
                  <Link href="/sign-in" className="flex items-center gap-2">
                    Get started
                    <ArrowRight className="h-4 w-4" />
                  </Link>
                </Button>
                <Button size="default" variant="outline" className="h-10 px-4 sm:h-12 sm:px-6 rounded-lg sm:rounded-xl border-white/20 bg-white/5 text-sm sm:text-base text-white hover:bg-white/10" onClick={handleGuest}>
                  Continue as guest
                </Button>
              </div>
            )}
        ...
        <div className="mt-10 sm:mt-20 grid gap-5 sm:gap-8 lg:grid-cols-3">
        ...
        <AnimatedTile index={3}>
          <div className="mt-10 sm:mt-20 w-full rounded-3xl border border-white/10 bg-white/5 px-4 py-10 shadow-lg shadow-black/30 md:px-8 lg:px-12 flex flex-col gap-8 sm:gap-12 items-center">
            <div className="w-full min-w-0 flex flex-col lg:flex-row gap-8 sm:gap-12 items-center justify-between">
              ...
              <div className="flex-1 flex flex-col items-center gap-8 min-w-0 w-full max-w-xl">
                ...
                <div className="flex flex-col gap-3 sm:gap-4 w-full lg:flex-row lg:gap-6 mt-2 sm:mt-4">
        ...
        <AnimatedTile index={4}>
          <div className="mt-10 sm:mt-20 max-w-3xl mx-auto w-full">
        ...
        <footer className="w-full mt-8 sm:mt-12 pb-6 flex justify-center">
